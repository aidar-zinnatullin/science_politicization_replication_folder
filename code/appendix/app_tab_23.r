#  R script to replicate Table 23 in Appendix E
...
table(smaller_corpus$ideology)
32754 + 46947 + 77765 == nrow(smaller_corpus)
...
tab23 <- tab23_df %>% 
  gt() %>% 
  tab_header(title = md("Table 23: Linear mixed-effects model results for the proportion of science-politicized (non-biomedical disciplines) COVID-19 content by media outlet ideological leaning.")) %>% 
  cols_align(align = "center", columns = -Variable)

gtsave(tab23, here("tables",  "tab_23_app.html"))
