# R script to test H2: Outlets farther from the ideological center exhibit a higher daily share of politicized biomedical coverage.
...
tab4 <- tab4_df %>% 
  gt() %>% 
  tab_header(title = md("Table 4. Linear mixed-effects results: daily share of politicized biomedical COVID-19 coverage by outlet ideology.")) %>% 
  cols_align(align = "center", columns = -Variable)

gtsave(tab4,  here("tables",  "table_4.html"))
