...
# R script to replicate Figure 3: Outlet similarity by daily share of science-politicized COV-19 coverage (DTW-based hierarchical clustering).
...
jpeg("figures/figure_3.jpeg", width = 9, height = 6, units = 'in', res = 500)
plot(hc, main = "Hierarchical clustering of the science politicization \nreporting trends about COVID-19 (biomedical disciplines)",
